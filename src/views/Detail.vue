<template>
    <div class="box">
        ...
        <ul class="goodslist">
            <li v-for="data in datalist.products" :key="data.productId" style="width:50%;float:left;list-style:none;" @click="goProductdetail(data.productId)"> 
                <div style="padding:10px;">
                    ...
                    <h3 style="text-align:left;font:600 16px/1 '';white-space: nowrap;text-overflow: ellipsis;overflow: hidden;margin-top:-20px" v-if="data.brandName">{{data.brandName}}</h3>
